...
import { seedProposalsFixtures } from "./seed-proposals";
import { seedClientOnboardingFixtures } from "./seed-client-onboarding";
...
async function main() {
  ...
  await seedProposalsFixtures();
  await seedClientOnboardingFixtures();
