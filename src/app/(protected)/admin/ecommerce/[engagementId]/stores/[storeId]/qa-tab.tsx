...
/**
 * E-Commerce Development builds ZERO new QA schema — required QA is
 * reused DIRECTLY from Project QA via the engagement's linked Project
 * (Build 27), read-only here (see
 * docs/architecture/ecommerce-development-os.md "QA"). Required QA is
 * engagement-scoped, not per-store (one Project may deliver several
 * stores) — this is the SAME count `getEcommerceStoreOverview()` itself
 * already reports, never re-derived here.
 */
