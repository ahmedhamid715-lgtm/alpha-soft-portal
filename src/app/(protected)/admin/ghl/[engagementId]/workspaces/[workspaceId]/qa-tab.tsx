...
/**
 * GHL Automation OS builds ZERO new QA schema — required QA is reused
 * DIRECTLY from Project QA via the engagement's linked Project (Build
 * 27), read-only here (see docs/architecture/ghl-automation-os.md
 * "QA"). Required QA is engagement-scoped, not per-workspace (one
 * Project may deliver several workspaces) — this is the SAME count
 * `getGhlWorkspaceOverview()` itself already reports, never re-derived
 * here.
 */
