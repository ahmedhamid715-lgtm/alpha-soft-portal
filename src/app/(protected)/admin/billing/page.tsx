 ...
 * Deliberately narrow: organization identity, billing account status,
 * current subscription status — never a payment-method number, never a
            ...
            <TableBody>
              {page.items.map((row) => (
                <TableRow key={row.organizationId}>
                  <TableCell>
                    <Link href={`${basePath}/organizations/${row.organizationId}`} className="font-medium text-link hover:underline">
