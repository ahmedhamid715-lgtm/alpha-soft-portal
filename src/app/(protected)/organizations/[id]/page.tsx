      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          {context.permissions.has("billing.read") ? (
            <Card>
              <CardContent>
                <Link href={`/organizations/${id}/billing`} className="flex flex-col gap-1 hover:underline">
                  <span className="font-medium">Billing</span>
                  <span className="text-sm text-muted-foreground">Plan, subscription, invoices</span>
                </Link>
              </CardContent>
            </Card>
          ) : null}
