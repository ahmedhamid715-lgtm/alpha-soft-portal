...
│   │                              organization-service.ts for the pattern)
...
prisma/
├── schema.prisma               # Organization/User/OrganizationMembership + enums (Module 03) —
│                                    see docs/architecture/database-schema.md for the reference
